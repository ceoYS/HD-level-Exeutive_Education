...
export const weeks: WeekData[] = [
  {
    ...
    intent: 'Book 03에서 고른 Pain Point·제품 유형·첫 실험 범위를 실제 제작의 출발 문서로 고정한다.',
    tasks: [
    ...
    deliverable: 'Build Brief · 1 page',
    prompt: {
      label: 'Build Brief를 만들 때',
      text: '지금까지 정한 Pain Point, 사용자, 현재 업무 흐름, 선택한 제품 유형, 시작 방식, 첫 실험 범위를 한 장의 Build Brief로 정리해줘. 내가 말하지 않은 요구사항은 추가하지 말고, 빠진 결정은 질문으로 남겨줘.',
      tone: 'signal',
    },
    certs: [
  ...
  },
  {
    ...
    intent: '확정한 PRD·SPEC·PLAN·TASKS를 Builder의 작업 맥락으로 넣고 핵심 흐름이 실제로 작동하게 만든다.',
    tasks: [
      'PRD·SPEC·PLAN·TASKS를 Builder에 제공',
      'Prototype에서 확정한 화면·흐름과 변경 금지 사항 명시',
      '가장 중요한 기능부터 구현',
      'Build/Test 결과 확인',
      '실제로 실행되는 MVP 확보',
    ],
    ...
    prompt: {
      label: 'Builder에 넘길 때',
      text: '첨부한 PRD·SPEC·PLAN·TASKS와 확정된 Prototype을 기준으로 작업해. 문서에 없는 요구사항은 추가하지 말고, 이번에는 핵심 흐름이 실제로 작동하는 MVP까지만 구현해. 구현 후 Build/Test 결과와 남은 TASKS를 보고해줘.',
    },
    certs: [
      { id: 'b04-w05-a', statement: '나는 문서를 Builder의 작업 맥락으로 넘겨 실제 기능을 만들었다.' },
  ...
  },
  {
    ...
    certs: [
      ...
      { id: 'b04-w08-b', statement: '나는 Pilot 결과를 기존 업무 방식과 비교해 말할 수 있다.', ace: true },
