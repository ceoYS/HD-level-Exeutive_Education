...
export const solutionTypes: SolutionType[] = [
  ...
  },
  {
    ...
    note: '화면부터(Prototype) 만들어 흐름을 확인한 뒤, 승인되면 실제 기능을 연결합니다.',
  },
  {
    key: 'automation',
    ...
    note: '대부분 미리 정해진 순서를 따릅니다. 판단이 필요한 지점은 사람이 남깁니다.',
  },
  {
    key: 'agent',
    name: 'AI Agent',
    ...
    note: '가장 강력하지만 가장 어렵습니다. 권한·관측·오류·비용·루프 제어·사람 승인이 함께 늘어납니다. 대개 Custom AI나 자동화로 부분을 검증한 뒤 좁게 시작합니다.',
  },
]
...
export const existingWorkflowAsks = [
  ...
  '무엇을 자동화하면 좋고, 무엇은 사람이 남겨야 하는지 제안해줘.',
]
...
export const difficultyRows: DifficultyRow[] = [
  { level: 'LOW', types: 'Custom AI · 간단한 Prototype', note: '오늘 바로 시작할 수 있는 범위' },
  { level: 'MEDIUM', types: 'Web / App · Workflow Automation', note: '화면·데이터·흐름 설계가 필요' },
  { level: 'HIGH', types: 'Agent · 다수 엔터프라이즈 통합', note: '권한·보안·운영·비용 관리가 함께' },
]
