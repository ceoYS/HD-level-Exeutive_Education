...
export const books: Book[] = [
  ...
  },
  {
    ...
    description: '대화로 정한 의도를 PRD·SPEC·작업 맥락으로 바꿔 Builder에 넘깁니다.',
    libraryLine: '의도를 구현 가능한 문서와 작업 맥락으로 바꿉니다.',
    note: '8 CHAPTERS',
    status: 'available',
    accent: '#ff6b41',
    foreground: '#1d1815',
  ...
  },
  {
    ...
    description: '작은 문제 하나를 Problem Brief부터 Targeted Fix까지 한 번 끝까지 만들어봅니다.',
    libraryLine: '6단계 Mini Build로 전체 흐름을 직접 연결합니다.',
    note: '6-STEP MINI BUILD',
    status: 'available',
    accent: '#efc653',
    foreground: '#201d13',
  },
